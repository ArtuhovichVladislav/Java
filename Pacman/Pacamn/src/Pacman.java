...
public class Pacman {
	 ...
	 * запоминает смещение, но устанавливает флан гевозможности движения в заданном направлении.
	 * 
	...
	/**
	  ...
	  * иначе - пользователь.
	  * 
	  * @param mode принимает значение true, если используется автоматический редим игры, 
