...
public class Game extends JFrame implements ActionListener{
	...
	public Game() throws FileNotFoundException{
		...
		if(Map.level == 0)
		{
			fileName = "H://универ//4 семестр//КПП//Pacamn//MyGames//Move//Move_"+getTimeAndDate()+".txt";
			ghostFileName = "H://универ//4 семестр//КПП//Pacamn//MyGames//Move//ghostMove_"+getTimeAndDate()+".txt";
			mainFileName = "H://универ//4 семестр//КПП//Pacamn//MyGames//Main_"+getTimeAndDate()+".txt";
	...
	private void initUI(){
	        ...
	        menuBar.add(menu);									//добавление в меню-бар
	...
	{
		mainFileName = "H://универ//4 семестр//КПП//Pacamn//MyGames/"+filename/*fileopen.getSelectedFile().getName()*/;
        try {
			setFileNames();
		} catch (FileNotFoundException e) {
			e.printStackTrace();
	...
	private void ReadFiles(){
		int x;
		File directory = new File("H://универ//4 семестр//КПП//Pacamn//MyGames/");
